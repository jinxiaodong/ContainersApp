...
//            mClearDrawable = getResources().getDrawable(R.drawable.delete_selector);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (hasFocus) {
            ...
            if (devider != null) {
                devider.setBackgroundColor(Color.parseColor("#0091ea"));
            }

        } else {
            if (devider != null) {
                devider.setBackgroundColor(Color.parseColor("#e4e4e4"));
            }
            setClearIconVisible(false);
        }
    }
    ...
    public void setonBackColorChange(final TextView textView) {
