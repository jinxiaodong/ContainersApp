...
public class HttpBodyRequest<T> extends HttpRequest<T> {
     ...
     *
     */
    public HttpBodyRequest setObjParams(Object objParams) {
     ...
     *
     */
    public HttpBodyRequest postWithJsonFormat(boolean value) {
...
//                SignUtil.createStringSignMap(map);
    ...
    private Request requestPost() {
        ...
        if (isPostJson) {
            ...
            String json = JsonUtil.objectToString(objParams);
